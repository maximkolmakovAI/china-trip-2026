...
export const PLACE_IMAGES: PlaceImageEntry[] = [
  ...
  { id: "science_museum", name: "Музей науки", aliases: ["Музей науки", "Science Museum"], images: [] },
  ...
  { id: "tiananmen", name: "Тяньаньмэнь", aliases: ["Тяньаньмэнь", "Tiananmen"], images: [] },
  ...
  { id: "great_wall_simatai", name: "Великая стена (Симатай)", aliases: ["Симатай", "Simatai"], images: [] },
  { id: "summer_palace", name: "Летний дворец", aliases: ["Летний дворец", "Summer Palace", "Yiheyuan"], images: [] },
  { id: "temple_of_heaven", name: "Храм Неба", aliases: ["Храм Неба", "Temple of Heaven"], images: [] },
  { id: "lama_temple", name: "Храм Ламы", aliases: ["Храм Ламы", "Lama Temple", "Yonghe"], images: [] },
  { id: "hutong_nanluoguxiang", name: "Хутун (Наньлогосян)", aliases: ["Наньлогосян", "Nanluoguxiang"], images: [] },
  { id: "wudaoying_hutong", name: "Бада хутун (Wudaoying)", aliases: ["Wudaoying", "Бада хутун", "Wudaoying Hutong"], images: [] },
  { id: "qianmen_hutong", name: "Хутуны Цяньмэнь", aliases: ["Цяньмэнь", "Qianmen", "хутунам Цяньмэнь"], images: [] },
  { id: "olympic_park", name: "Олимпийский парк", aliases: ["Олимпийский парк", "Olympic Park"], images: [] },
  { id: "birds_nest", name: "Национальный стадион", aliases: ["Национальный стадион", "Bird's Nest", "Bird", "Национальный"], images: [] },
  { id: "wangfujing", name: "Ванфуцзин", aliases: ["Ванфуцзин", "Wangfujing"], images: [] },
  { id: "wangfujing_market", name: "Ночной рынок Ванфуцзин", aliases: ["рынок Ванфуцзин", "Wangfujing night market", "ночному рынку"], images: [] },
  { id: "gulou", name: "Гулоу (Барабанная башня)", aliases: ["Гулоу", "Барабанная башня", "Drum Tower", "Gulou"], images: [] },
  { id: "beihai_park", name: "Парк Бэйхай", aliases: ["Бэйхай", "Beihai"], images: ["/images/places/beihai_park/beihai_park_2.jpg"] },
  { id: "798_art", name: "798 Art Zone", aliases: ["798", "Art Zone"], images: [] },
  { id: "beijing_zoo", name: "Пекинский зоопарк (панды)", aliases: ["панды", "Beijing Zoo", "Zoo", "панд"], images: [] },
  { id: "universal_beijing", name: "Universal Beijing Resort", aliases: ["Universal", "Universal Beijing"], images: [] },
  { id: "liu_xinyuan", name: "Парк Лю Синя", aliases: ["Лю Синя", "Liu Xinyuan", "Лю Син"], images: [] },

  // === OTHER CITIES ===
  { id: "west_lake", name: "Озеро Сиху (West Lake)", aliases: ["Сиху", "West Lake", "Xi Hu", "озеро Сиху"], images: [] },
  { id: "lingyin_temple", name: "Линъинь Сы (Ханчжоу)", aliases: ["Линъинь", "Lingyin"], images: [] },
  { id: "meijiawu", name: "Чайная деревня Мэйцзяу", aliases: ["Мэйцзяу", "Meijiawu", "чайная деревня"], images: [] },
  { id: "qingshanhu", name: "Qingshanhu Water Forest", aliases: ["Qingshanhu", "Water Forest"], images: [] },
  { id: "huangshan_mountains", name: "Жёлтые горы (Huangshan)", aliases: ["Жёлтые горы", "Huangshan", "Хуаншань"], images: [] },
  { id: "huangshan_hot_springs", name: "Горячие источники Хуаншань", aliases: ["Горячие источники", "hot springs"], images: [] },
  { id: "ningbo_city", name: "Нинбо", aliases: ["Нинбо", "Ningbo"], images: [] },
  { id: "tianyi_ge", name: "Тяньи-гэ (Нинбо)", aliases: ["Тяньи", "Tianyi"], images: [] },
  { id: "baoguo_temple", name: "Храм Баого (Нинбо)", aliases: ["Баого", "Baoguo"], images: [] },
  { id: "houwan_village", name: "Houwan Village", aliases: ["Houwan", "заброшенная деревня"], images: [] },
